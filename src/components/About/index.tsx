                            ...
                            <div className='lg:py-5 lg:flex lg:justify-between'>
                                <div className=''>
                                    <div className='flex gap-1 p-2 items-center'>
                                        ...
                                        <h2 className='text-lg'>1 May 1970</h2>
                                    </div>
                                    <div className='flex gap-1 p-2 items-center'>
                                        <IoIosArrowForward />
                                    ...
                                    <div className='flex gap-1 p-2 items-center'>
                                        ...
                                        <h2 className='text-lg'>+91 993234342</h2>
                                    </div>
                                    <div className='flex gap-1 p-2 items-center'>
                                        <IoIosArrowForward />
                                ...
                                <div className=''>
                                    <div className='flex gap-1 p-2 items-center'>
                                        ...
                                        <h2 className='text-lg'>52</h2>
                                    </div>
                                    <div className='flex gap-1 p-2 items-center'>
                                        <IoIosArrowForward />
                                        <h1 className='text-lg font-semibold'>Email:</h1>
                                        <h2 className='text-lg'>ad@gmail.com</h2>
                                    </div>
                                    <div className='flex gap-1 p-2 items-center'>
                                        <IoIosArrowForward />
                    ...
                    <div className='lg:w-full lg:pt-[50px] '>
                        ...
                        <div className='w-full lg:flex  lg:py-8 lg:justify-around py-5 sm:gap-2 '>
                            <div className='flex lg:flex-row flex-col text-center  gap-2 lg:p-0 p-1 ' data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                ...
                                <div className='  '>
                                    <h1 className='lg:text-6xl sm:text-3xl font-medium lg:p-0 p-1'>130+</h1>
